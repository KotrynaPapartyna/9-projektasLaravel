...
return [
    ...
    /*
    spec columns   cia galima itraukti stulpeliu- alpha- "title) tada AZ atsiras prie to stuleplio
    */
    'columns'                       => [
        'alpha'   => [
     ...
     */
    'default_icon_set'              => 'fa fa-sort', // galima keisti rodyklytes pagal font awesome

    /*
    icon that shows when generating sortable link while column is not sorted
     */
    'sortable_icon'                 => 'fa fa-sort', // galima keisti rodyklytes pagal font awesome

    /*
    generated icon is clickable non-clickable (default)
     */
    'clickable_icon'                => true,  // jeigu false- aktyvus tekstas
     ...
     */
    'default_direction'             => 'asc', // cia pakeitus i desc su true 114- pasikeicia rikiavimas
     ...
     */
    'default_first_column'          => false, // jeigu true ir 103- desc- bus mazejancia tvarka
